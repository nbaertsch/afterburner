...
raster dimensions and nonblank pixel diversity, every visual evidence manifest entry names a generated
screenshot with proof text, and all open/reopen/scroll/refresh/close interactions stay within the harness latency budgets for agent-run visual QA.
