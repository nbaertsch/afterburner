...
func SupportedComponentKinds() []component.Kind {
	return []component.Kind{
		...
		kindMeter, kindBar, component.KindSparkline, component.KindStatusGrid,
		...
		component.KindAlert, component.KindToast, kindLoading, kindErrorBoundary, kindConfirmation, kindPrompt,
