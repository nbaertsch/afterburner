...
func TestAriaPropsPopulateAccessibilityProjection(t *testing.T) {
	tree := SourceTree{SurfaceID: "s", Root: SourceNode{ID: "root", Kind: "application", Children: []SourceNode{
		{ID: "assertive", Kind: "statusGrid", Props: map[string]any{"label": "Build failed", "ariaLive": "assertive", "ariaDescription": "See failed job details", "ariaInvalid": "spelling", "aria-current": "page", "ariaOrientation": "vertical", "ariaPosInSet": 2, "ariaSetSize": 5, "ariaAtomic": true, "ariaRelevant": []any{"additions", "text"}, "ariaBusy": true, "ariaExpanded": false, "ariaSelected": true, "ariaLabelledBy": "heading summary", "ariaDescribedBy": []any{"details", "hint"}, "ariaControls": "details-panel", "ariaActiveDescendant": "failed-job", "ariaErrorMessage": "error-summary", "ariaDetails": []any{"details-panel", "debug-log"}, "ariaSort": "ascending", "ariaRowIndex": 3, "ariaColIndex": 4, "ariaRowSpan": 2, "ariaColSpan": 1, "ariaRowCount": 10, "ariaColCount": 6}},
