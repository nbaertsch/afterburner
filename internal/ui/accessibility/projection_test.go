...
func TestAriaPropsPopulateAccessibilityProjection(t *testing.T) {
	tree := SourceTree{SurfaceID: "s", Root: SourceNode{ID: "root", Kind: "application", Children: []SourceNode{
		{ID: "assertive", Kind: "statusGrid", Props: map[string]any{"label": "Build failed", "ariaLive": "assertive", "ariaDescription": "See failed job details", "ariaInvalid": "spelling", "ariaCurrent": "page", "ariaPosInSet": 2, "ariaSetSize": 5, "ariaAtomic": true, "ariaRelevant": []any{"additions", "text"}, "ariaBusy": true, "ariaExpanded": false, "ariaSelected": true, "ariaLabelledBy": "heading summary", "ariaDescribedBy": []any{"details", "hint"}, "ariaControls": "details-panel", "ariaActiveDescendant": "failed-job"}},
	...
	if assertive.Description != "See failed job details" || assertive.States["invalid"] != "spelling" || assertive.States["current"] != "page" || assertive.States["positionInSet"] != "2" || assertive.States["setSize"] != "5" || assertive.States["atomic"] != "true" || assertive.States["relevant"] != "additions text" || assertive.States["busy"] != "true" || assertive.States["expanded"] != "false" || assertive.States["selected"] != "true" {
